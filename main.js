...
var author$project$Main$getConversion = function (model) {
	return elm$http$Http$request(
		{
			body: A2(
...
var author$project$Main$prettify = _Platform_outgoingPort('prettify', elm$json$Json$Encode$string);
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'DisplayConversionResult':
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'RadioMsg':
				...
				if (state.$ === 'URL') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{inputFieldText: 'hidden', inputFieldUrl: 'shown', radioState: state}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
...
var author$project$Main$RadioMsg = function (a) {
	return {$: 'RadioMsg', a: a};
};
var author$project$Main$TEXT = {$: 'TEXT'};
var author$project$Main$UpdateFrom = function (a) {
	return {$: 'UpdateFrom', a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Input format - '),
										A2(
										elm$html$Html$span,
										_List_Nil,
										_List_fromArray(
													...
													[
														...
														_List_fromArray(
															[
																...
																elm$html$Html$Attributes$name('input-type'),
																elm$html$Html$Events$onClick(
																author$project$Main$RadioMsg(author$project$Main$TEXT))
															]),
														_List_Nil)
													]))
											]))
								...
								_List_fromArray(
									[
										elm$html$Html$text('Convert From '),
										A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateFrom('guess'))
													]),
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateFrom('json'))
													]),
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateFrom('rdfxml'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('RDF/XML')
													])),
												A2(
												elm$html$Html$option,
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateFrom('php'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('RDF/PHP')
													])),
												A2(
												elm$html$Html$option,
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateFrom('turtle'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('Turtle')
													])),
												A2(
												elm$html$Html$option,
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateFrom('ntriples'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('N-Triples')
													])),
												A2(
												elm$html$Html$option,
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateFrom('jsonld'))
													]),
												_List_fromArray(
													[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateTo('json'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('JSON')
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateTo('rdfxml'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('RDF/XML')
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateTo('php'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('RDF/PHP')
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateTo('turtle'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('Turtle')
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateTo('ntriples'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('N-Triples')
												...
												_List_fromArray(
													[
														elm$html$Html$Events$onClick(
														author$project$Main$UpdateTo('jsonld'))
													]),
												_List_fromArray(
													[
														elm$html$Html$text('JSON-LD')
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onClick(author$project$Main$DisplayConversionResult)
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('row content-area')
							]),
						_List_fromArray(
							[
								A2(
